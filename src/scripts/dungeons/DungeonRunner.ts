...
class DungeonRunner {
    ...
    public static dungeonSize(dungeon: any): number {
        ...
        dungeonSize -= Math.max(0, App.game.statistics.dungeonsCleared[GameConstants.getDungeonIndex(dungeon.name)]().toString().length - 1);
